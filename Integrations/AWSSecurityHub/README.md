...
|Max Results to Return|Specify how many results to return.|False|String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Severity|Specify new severity for the finding.|False|List||
...
|Verification State|Specify a new verification state for the finding.|False|List||
...
|Workflow Status|Specify new workflow status for the finding.|False|List||
...
|Group By Attribute|Specify a new name of the attribute by which findings should be grouped under one insight.|False|List||
